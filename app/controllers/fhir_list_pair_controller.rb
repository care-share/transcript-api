...
class ListPairController < ApplicationController
  ...
  gem "transcript"
  require "med_order_working/fhir_prescription"    #prescription
  require "medrec/aligner.rb"
  require "med_order_working/fhir_med_order_reader.rb"    #list_pair_reader
...
###    headers['Access-Control-Allow-Credentials'] = 'true'
  ...
  def align #POST
    puts params[:listpair].inspect
    reader = FHIRMedOrderReader.new(params[:listpair])
    pipeline_array = [ListPairPrescriptionFeatureExtractor.new, Aligner.new, \
                      AlignedListStrictStringMatchDiscrepancyDetector.new(["name"]), \
